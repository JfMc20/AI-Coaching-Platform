...
Fixtures are now centralized in tests/fixtures/channel_fixtures.py and automatically
...
class TestWebSocketConnections:
    ...
    def test_websocket_connection_limits(self, websocket_client):
        ...
        try:
            for i in range(max_connections):  # Don't exceed limit
                try:
    ...
    def test_websocket_performance(self, websocket_client, test_websocket_session):
