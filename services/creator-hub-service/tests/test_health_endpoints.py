...
class TestHealthEndpoints:
    ...
    async def test_concurrent_health_checks(self, client: AsyncClient):
        ...
        tasks = [client.get("/api/v1/health") for _ in range(5)]
    ...
    async def test_health_check_with_invalid_method(self, client: AsyncClient):
    ...
    async def test_deep_health_check(self, client: AsyncClient):
    ...
    async def test_service_info_endpoint(self, client: AsyncClient):
