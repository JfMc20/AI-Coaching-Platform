"""
AI Engine service specific pytest configuration.
...
def test_embeddings():
    ...
    import random
    return {
        "embedding_384": [random.random() for _ in range(384)],
        "embedding_768": [random.random() for _ in range(768)],
        "embedding_1536": [random.random() for _ in range(1536)]
    }
